    ...
    return (
        <div className={baseStyle["panel-content"]}>
            ...
            <div className={containerContentStyle["container-content-stats"]}>
                ...
                |
                <div className={baseStyle["panel-content-row"]}>Network: <span className={baseStyle["panel-content-row-highlight"]}>{humanFileSize(props.statistics.network)}/s</span></div>
                |
                <div className={baseStyle["panel-content-row"]}>Disk: <span className={baseStyle["panel-content-row-highlight"]}>{humanFileSize(props.statistics.disk)}/s</span></div>
            </div>
