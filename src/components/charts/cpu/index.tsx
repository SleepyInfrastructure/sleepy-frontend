    ...
    return <div className={style.chart}>
        ...
        <ResponsiveContainer width="100%" height="85%">
            <LineChart data={props.statistics} margin={{ top: 10, bottom: 10 }}>
                ...
                <Tooltip labelFormatter={formatTimestampShort} formatter={(e: number) => `${e.toFixed(2)}%`} labelStyle={{ color: "var(--color-primary-text)" }} contentStyle={{ background: "var(--color-primary-dark)", border: 0 }} wrapperStyle={{ border: 0 }} />
