    ...
    return <div className={style.chart}>
        ...
        <ResponsiveContainer width="100%" height="85%">
            <LineChart data={props.statistics} margin={{ top: 10, bottom: 10 }}>
                ...
                <Tooltip labelFormatter={formatTimestamp} formatter={(e: number) => `${e.toFixed(2)}%`} labelStyle={{ color: "#ff3645" }} contentStyle={{ background: "#202020", border: 0 }} wrapperStyle={{ border: 0 }} />
