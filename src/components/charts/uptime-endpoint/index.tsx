...
import { formatTimestamp } from "../../../scripts/util/util";
/* Styles */
    ...
    return <div className={style.chart}>
        ...
        <ResponsiveContainer width="100%" height="85%">
            <LineChart data={statistics} margin={{ top: 10, bottom: 10, left: 10, right: 10 }}>
                ...
                <YAxis tickFormatter={(e: number) => `${e.toFixed(0)} ms`} tickMargin={8} padding={{ top: 20, bottom: 20 }} tick={{ fill: "#ff3645" }} />
                <Tooltip labelFormatter={formatTimestamp} formatter={(e: number) => `${e.toFixed(0)} ms`} labelStyle={{ color: "#ff3645" }} contentStyle={{ background: "#202020", border: 0 }} wrapperStyle={{ border: 0 }} />
